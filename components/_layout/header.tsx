...
export default function Header(props : any){
    ...
    <div className="mr-auto container px-5 py-4 mx-auto flex items-center flex-row">
      ...
      <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-10 h-10 text-white p-2 bg-gray-800 hover:bg-gray-700 rounded-full" viewBox="0 0 24 24">
