  ...
  return (
    <>
      ...
      <div className="w-11/12 md:w-1/2 lg:w-2/6 h-full   
            mt-16
            border rounded-lg mx-auto">
            <div className="flex flex-col bg-white p-6">
            <h1 className="mx-auto text-3xl font-bold">Login</h1>
            <div className="border-b-2 mt-3"></div>
            <button onClick={loginWithGithub} className="flex items-center justify-center mt-4 text-gray-600 rounded-lg shadow-md dark:bg-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600">
                <div className="px-4 py-3">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 496 512" className="w-6 h-6" xmlns="http://www.w3.org/2000/svg">
